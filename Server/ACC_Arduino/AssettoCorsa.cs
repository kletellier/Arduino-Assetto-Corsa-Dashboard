...
/*
// https://github.com/mdjarv/assettocorsasharedmemory updated with ACC mapping
*/
...
namespace AssettoCorsaSharedMemory
{
    ...
    public class AssettoCorsaNotStartedException : Exception
    {
        public AssettoCorsaNotStartedException()
            : base("Shared Memory not connected, is Assetto Corsa Competitzione running and have you run assettoCorsa.Start()?")
        {
        }
    }
